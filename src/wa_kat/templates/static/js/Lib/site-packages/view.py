...
import publisher_switcher  # this have to be imported to activate the bindings
    ...
    def validate(self):
        ...
        for prop in properties:
            if hasattr(prop, "validate"):
                ...
                # prop.validate() will also return from this function if used with and operator
